...
export default function Index({
    ...
    }, [search, brandFilter, statusFilter, sortField, sortDirection]);
    ...
    const handleSort = (field) => {
        // 3-state cycle: none → asc → desc → none (reset)
        if (sortField !== field) {
    ...
    const renderSortIcon = (field) => {
        if (sortField !== field) {
            return (
                <svg className="w-4 h-4 ml-1 text-gray-400 invisible group-hover:visible inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        if (sortDirection === 'asc') {
            return (
                <svg className="w-4 h-4 ml-1 text-gray-900 dark:text-gray-100 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 15l7-7 7 7" />
                </svg>
            );
        }
        // desc — next click will reset
        return (
            <svg className="w-4 h-4 ml-1 text-gray-900 dark:text-gray-100 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                <thead className="bg-gray-50 dark:bg-gray-700">
                                                    <tr>
                                                        ...
                                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer group hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('retail_price')}>
                                                            <div className="flex items-center">
                                                                Pricing {renderSortIcon('retail_price')}
                                                            </div>
                                                        </th>
                                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                                            Status
