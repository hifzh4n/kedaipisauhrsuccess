...
export default function Index({
    ...
    // Update stockHistory when prop changes
    useEffect(() => {
        if (initialStockHistory) {
    ...
    const lastHandledExportRef = useRef(null);
    ...
    const downloadQueuedExport = (filename) => {
        return downloadRouteFile(`/stocks/download-pdf/${filename}`, filename);
    };

    const pollQueuedExport = (targetFilename) => {
        stopExportPolling();

        exportPollingRef.current = setInterval(async () => {
            try {
                const response = await fetch("/stocks/export-status", {
                    headers: {
                        Accept: "application/json",
                ...
                if (matching.status === "completed") {
                    stopExportPolling();
                    if (lastHandledExportRef.current !== targetFilename) {
                        lastHandledExportRef.current = targetFilename;
                        toast.success("Stock PDF is ready. Download starting...");
                        downloadQueuedExport(targetFilename)
                            .then((result) => {
                                if (result?.canceled) {
                            ...
                            .catch((downloadError) => {
                                console.error("Failed to download stock export:", downloadError);
                                toast.error(downloadError.message || "Download failed.");
                            });
                    }
                    return;
                }
                ...
                if (matching.status === "failed") {
                    ...
                    toast.error(
                        matching.error_message ||
                            "Stock PDF export failed. Please try again."
                    );
                }
            } catch (pollError) {
                console.error("Failed to poll stock export status:", pollError);
            }
        }, 5000);
    };
    ...
    const handleExportSubmit = async (e) => {
        ...
        try {
            ...
            formData.append("report_type", reportTypeMap[exportForm.report_type]);
            ...
            formData.append("movement_type", exportForm.movement_type || "");
            formData.append("date_from", exportForm.export_from_date || "");
            formData.append("date_to", exportForm.export_to_date || "");
            ...
            if (contentType.includes("application/json")) {
                ...
                if (data.status === "queued" && data.filename) {
                    toast.success(data.message || "Export queued successfully.");
            ...
            const saveResult = await saveResponseFile(
                response,
                `stock_report_${exportForm.report_type}_${new Date()
                    .toISOString()
                    .slice(0, 19)
                    .replace(/:/g, "-")}.pdf`
            );
            ...
            toast.error(submitError.message || "Export failed.");
        } finally {
                            ...
                            <div className="overflow-x-auto sm:overflow-x-visible">
                                <nav className="-mb-px flex space-x-4 sm:space-x-8 px-6 pt-6 sm:min-w-0 min-w-max">
                                    <button
                                        ...
                                        className={`py-2 px-2 sm:px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === "stock-movement"
                                    ...
                                    <button
                                        ...
                                        className={`py-2 px-2 sm:px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === "stock-in"
                                            ? "border-indigo-500 text-indigo-600 dark:text-indigo-400"
                                            : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`py-2 px-2 sm:px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === "stock-out"
                                            ? "border-indigo-500 text-indigo-600 dark:text-indigo-400"
                                            : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`py-2 px-2 sm:px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === "stock-aging"
                                            ? "border-indigo-500 text-indigo-600 dark:text-indigo-400"
                                            : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`py-2 px-2 sm:px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === "damaged-items"
                                    ...
                                    <button
                                        ...
                                        className={`py-2 px-2 sm:px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === "stock-calculator"
                                            ? "border-indigo-500 text-indigo-600 dark:text-indigo-400"
                                            : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`py-2 px-2 sm:px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === "export-pdf"
                                            ? "border-indigo-500 text-indigo-600 dark:text-indigo-400"
                                            : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300"
                                            }`}
                                    >
                                                                    ...
                                                                    stockHistory.data.map(
                                                                        (movement) => (
                                                                            ...
                                                                            >
                                                                                    ...
                                                                                    <div className="flex items-center">
                                                                                        <div className="flex-shrink-0 h-10 w-10">
                                                                                            {movement
                                                                                                ...
                                                                                                ?.picture_url ? (
                                                                                                <img
                                                                                                    key={movement._imageKey || movement.id}
                                                                                                    ...
                                                                                                    onLoad={() => {
                                                                                                        ...
                                                                                                        if (movement._imageKey) {
                                                                                                            setStockHistory(prevHistory => ({
                                                                                                                ...prevHistory,
                                                                                                                data: prevHistory.data.map(prevMovement =>
                                                                                                                    prevMovement.id === movement.id ?
                                                                                                                        { ...prevMovement, _imageLoaded: true } :
                                                                                                                        prevMovement
                                                                                                                )
                                                                                                            }));
                                                                                                        }
                                                                                ...
                                                                                <td className="px-6 py-4 whitespace-nowrap">
                                                                                    <span
                                                                                        className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${movement.type ===
                                                                                            "in"
                                                                ...
                                                                onClick={() => {
                                                                    if (link.url) {
                                                                        ...
                                                                        router.get(
                                                                            ...
                                                                            {
                                                                                search: search,
                                                                                status: typeFilter, // Changed from statusFilter to typeFilter based on context
                                                                                date_from:
                                                                                    dateFrom,
                                                                                date_to:
                                                                                    dateTo,
                                                                    ...
                                                                    {stockOutSearchResults.map(
                                                                        (
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                className={`flex items-center p-3 border-b border-gray-100 dark:border-gray-700 last:border-b-0 transition-colors duration-150 ${(item.quantity ||
                                                                                    0) >
                                                                                    0
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div className="flex-1 min-w-0">
                                                                                    ...
                                                                                    <div className="text-xs text-gray-500 dark:text-gray-400 space-x-2">
                                                                                        ...
                                                                                        <span
                                                                                            className={`font-medium ${(item.quantity ||
                                                                                                0) >
                                                                                                0
                            ...
                            {activeTab === "stock-aging" && (
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white dark:bg-gray-700 rounded-lg shadow-sm p-6">
                                        ...
                                        {/* Stock Aging Table */}
                                        <div className="relative">
                                            <div className="overflow-x-auto -mx-4 sm:mx-0" style={{ overflowY: "visible", overflowX: "auto" }}>
                                                <div className="inline-block min-w-full align-middle">
                                                    <div className="shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                            <thead className="bg-gray-50 dark:bg-gray-700">
                                                                    ...
                                                                    stockAgingData.data.map(
                                                                        (batch) => (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                                                    <span
                                                                                        className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${(batch.quantity_remaining ||
                                                                                            0) ===
                                                                                            0
                                                                                            ? "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300"
                                                                                ...
                                                                                <td className="px-6 py-4 whitespace-nowrap">
                                                                                    <span
                                                                                        className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${batch.status ===
                                                                                            "Fresh"
                                                                                            ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300"
                                                                                            : batch.status ===
                                                                                                "Aging"
                                                                                ...
                                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                                                    <button
                                                                                        ...
                                                                                        className={`${batch.quantity_remaining >
                                                                                            0
